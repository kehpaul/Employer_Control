...
If(isset($_POST['username']))
{
	...
	if($checknumrows == 0)
	{
		...
		$_SESSION['ADMINNAME'] = $userrow['username'];
		...
		if(isset($_SESSION['ADMINNAME']))
		{
			...
			{
$updatelog = "UPDATE admin SET log='online' WHERE id='{$_SESSION['ADMINID']}' ";
$log = mysqli_query($db,$updatelog);
$time = date("d-m-y H:i:s", time());
$last_log = "UPDATE admin SET lastlog= '{$time}' WHERE id='{$_SESSION['ADMINID']}' " ;
